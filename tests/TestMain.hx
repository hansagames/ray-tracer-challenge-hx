...
class TestMain implements Buddy<[
	...
	CamerasTest, ShapeTest, SphereTest, PlaneTest, PatternsTest, CubeTest, CylinderTest, ConeTest, GroupCreatorTest, GroupTest, TriangleTest, ObjTest, SmoothTriangleTest,CSGTest
]> {}
